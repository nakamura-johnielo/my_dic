...
import 'package:my_dic/features/search/internal/application/usecase/search_word/search_word_interactor.dart';
...
class _SearchQueryRepositoryFake implements SearchQueryPort {
  SearchQuery? query;
