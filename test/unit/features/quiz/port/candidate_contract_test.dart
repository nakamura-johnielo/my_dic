...
void main() {
  test('candidate contracts retain Catalog identity and zero-based pagination',
    ...
    const raw = CatalogRawQuizCandidateHit(word: word, headword: 'hablar');
  ...
  test('Quiz and Catalog port sources contain no framework imports', () {
    final files = [
      ...Directory('lib/features/quiz/port')
          .listSync(recursive: true)
          .whereType<File>(),
      File('lib/features/catalog/port/raw_quiz_candidate_reader.dart'),
