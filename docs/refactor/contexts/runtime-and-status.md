...
6. Auth lifecycleは`core/application/auth_lifecycle`が現在の中心。だが`AuthStoreNotifier`、`AppUserStoreNotifier`、旧Coordinatorも残っており、Phase 1-4でCurrentSessionへ整理する余地がある。
