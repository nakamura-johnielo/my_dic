...
- [ ] loading、data、empty、failureを区別できる
- [ ] `null`や空listがfailureの代用になっていない
- [ ] command failureで成功UIを表示しない
- [ ] error message変換がpresentationにある
- [ ] state transition testが主要ViewModelにある
