...
class RankingController {
  ...
  void loadPrevious(int page, int size) {
    log("load:$page");
    /* LoadRankingsInputData input = LoadRankingsInputData(page, size);
    _loadRankingsInteractor.execute(input); */
    _loadItemsByFilters();
  ...
  void _loadItemsByFilters() {
    LoadRankingsInputData inputGetItems = LoadRankingsInputData(
        _rankingViewModel.partOfSpeechFilters,
        _rankingViewModel.featureTagFilters,
        _rankingViewModel.currentPage[1],
        _rankingViewModel.size);

    _loadRankingsInteractor.execute(inputGetItems);
  }
