...
//   //firebase
//   // DI.registerFactory<FirebaseAuthDataSource>(() => FirebaseAuthDataSource());
//   // DI.registerFactory<IAuthRepository>(
//   //     () => FirebaseAuthRepository(DI<FirebaseAuthDataSource>()));

//   // DI.registerFactory<UserDao>(() => UserDao());

//   // DI.registerFactory<IUserRepository>(
//   //     () => FirebaseUserRepository(DI<UserDao>()));

//   // DI.registerFactory<ObserveAuthStateInteractor>(() =>
//   //     ObserveAuthStateInteractor(DI<IAuthRepository>(), DI<IUserRepository>()));
