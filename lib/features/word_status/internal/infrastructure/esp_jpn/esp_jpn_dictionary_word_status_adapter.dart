...
final class EspJpnDictionaryWordStatusAdapter
    implements DictionaryWordStatusAdapter {
  EspJpnDictionaryWordStatusAdapter(this._local, this._outboxWriter,
      {Uuid? uuid})
  ...
  void _checkCatalog(CatalogWordRef word) {
    ...
    if (word.catalogId != catalogId) {
      throw ArgumentError.value(word.catalogId, 'word.catalogId',
          'EspJpnDictionaryWordStatusAdapter only handles $catalogId.');
    }
  }
