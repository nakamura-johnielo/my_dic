...
final class JpnEspDictionaryWordStatusStore
    implements DictionaryWordStatusStore {
  JpnEspDictionaryWordStatusStore(this._local, this._outboxWriter,
      {Uuid? uuid})
  ...
  void _checkCatalog(CatalogWordRef word) {
    ...
    if (word.catalogId != catalogId) {
      throw ArgumentError.value(word.catalogId, 'word.catalogId',
          'JpnEspDictionaryWordStatusStore only handles $catalogId.');
    }
  }
