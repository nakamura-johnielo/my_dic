...
/// Testable seam for Search's ranking enrichment projection.
abstract interface class SearchRankingLookup {
  Future<Map<int, int>> getRankingNosByWordIds(List<int> wordIds);
}

/// Drift implementation kept on Catalog's provider side.
class DriftSearchRankingLookup implements SearchRankingLookup {
  DriftSearchRankingLookup(this._database);
