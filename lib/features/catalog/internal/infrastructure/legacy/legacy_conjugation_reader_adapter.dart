...
final class LegacyConjugationReaderAdapter implements ConjugationReader {
  const LegacyConjugationReaderAdapter(this._repository);
  ...
  Future<Result<CatalogConjugation?>> getConjugation(
    ...
    return result.when(
      success: (conjugation) => Result.success(
        conjugation == null
            ? null
            : LegacyCatalogMapper.conjugation(word, conjugation),
      ),
