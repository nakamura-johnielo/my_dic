...
class JpnEspStatusButtons extends ConsumerWidget {
  const JpnEspStatusButtons({super.key, required this.wordId});
  final int wordId;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final vm = ref.watch(jpnEspWordStatusViewModelProvider(wordId));
