...
import 'package:my_dic/features/esp_jpn_word_status/components/status_button/myword/myword_di.dart';
...
class MyWordStatusButtons extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final vm = ref.watch(mywordStatusViewModelProvider(wordId));
