...
part '../../../../../__generated/features/ranking/internal/infrastructure/drift/ranking_dao.g.dart';
...
class RankingDao extends DatabaseAccessor<DatabaseProvider>
  ...
  Future<List<RankingQueryRow>> fetchRankingQueryPage(
    ...
    final selectColumns = groupByWord
        ? '''MIN(r.ranking_id) AS ranking_id, MIN(r.ranking_no) AS ranking_no, MIN(r.word) AS word,
            MIN(r.word_origin) AS word_origin, r.word_id AS word_id'''
        : '''r.ranking_id AS ranking_id, r.ranking_no AS ranking_no, r.word AS word,
