...
enum SearchConjugationMatchKey {
  ...
  indicativePreteriteNosotros(
    SearchMoodTense.indicativePreterite,
    SearchSubject.nosotros,
  ),
  ...
  indicativeImperfectNosotros(
    SearchMoodTense.indicativeImperfect,
    SearchSubject.nosotros,
  ),
  ...
  indicativeFutureNosotros(
    SearchMoodTense.indicativeFuture,
    SearchSubject.nosotros,
  ),
  ...
  subjunctivePresentNosotros(
    SearchMoodTense.subjunctivePresent,
    SearchSubject.nosotros,
  ),
  ...
  subjunctivePastNosotros(
    SearchMoodTense.subjunctivePast,
    SearchSubject.nosotros,
  ),
