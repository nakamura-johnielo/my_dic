...
import 'package:my_dic/features/my_word/data/sync/remote/myword/firebase_my_word_dao.dart';
import 'package:my_dic/features/my_word/data/sync/remote/myword/firebase_my_word_data_source.dart';
...
import 'package:my_dic/features/my_word/data/sync/remote/status/firebase_my_word_status_data_source.dart';
...
final myWordRepositoryProvider = Provider<IMyWordRepository>((ref) {
  return MyWordRepository(
    ...
    ref.read(driftOutboxWriterProvider),
  );
});
