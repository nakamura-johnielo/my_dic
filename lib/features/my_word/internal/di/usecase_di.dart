...
import 'package:my_dic/features/my_word/internal/application/usecase/my_word/delete/delete_my_word/delete_my_word_interactor.dart';
...
import 'package:my_dic/features/my_word/internal/application/usecase/my_word/create/register_my_word/register_my_word_interactor.dart';
...
final loadMyWordUseCaseProvider = Provider<ILoadMyWordUseCase>((ref) {
  return LoadMyWordInteractor(ref.read(myWordRepositoryProvider));
});

final updateMyWordStatusUseCaseProvider =
    Provider<IUpdateMyWordStatusUseCase>((ref) {
  return UpdateMyWordStatusInteractor(ref.read(myWordStatusRepositoryProvider));
});

final registerMyWordUseCaseProvider = Provider<IRegisterMyWordUseCase>((ref) {
  return RegisterMyWordInteractor(ref.read(myWordRepositoryProvider));
});

final updateMyWordUseCaseProvider = Provider<IUpdateMyWordUseCase>((ref) {
  return UpdateMyWordInteractor(ref.read(myWordRepositoryProvider));
});

final deleteMyWordUseCaseProvider = Provider<IDeleteMyWordUseCase>((ref) {
  return DeleteMyWordInteractor(ref.read(myWordRepositoryProvider));
});

final watchMyWordStatusUseCaseProvider =
    Provider<WatchMyWordStatusUsecase>((ref) {
  return WatchMyWordStatusInteractor(ref.read(myWordStatusRepositoryProvider));
});

final watchMyWordUseCaseProvider = Provider<WatchMyWordUsecase>((ref) {
  return WatchMyWordInteractor(ref.read(myWordRepositoryProvider));
});
