...
part of '../../../../../../../../_Business_Rule/_Domain/Entities/dictionary/sub/example/impl/example.dart';
...
abstract class $ExampleCopyWith<$Res> {
  ...
  @useResult
  $Res call({int exampleId, String japanese, String espanol});
}
...
class _$ExampleImpl implements _Example {
  const _$ExampleImpl(
      {required this.exampleId, required this.japanese, required this.espanol});
  ...
  @override
  String toString() {
    return 'Example(exampleId: $exampleId, japanese: $japanese, espanol: $espanol)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, exampleId, japanese, espanol);
...
abstract class _Example implements Example {
  const factory _Example(
      ...
      required final String espanol}) = _$ExampleImpl;
