...
part of '../../../../../core/infrastructure/database/drift/database_provider.dart';
...
class $EspJpnExamplesTable extends EspJpnExamples
  ...
  @override
  late final GeneratedColumn<int> dictionaryId = GeneratedColumn<int>(
      'dictionary_id', aliasedName, true,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
...
class EspJpnExampleTableData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || dictionaryId != null) {
      map['dictionary_id'] = Variable<int>(dictionaryId);
    }
  ...
  EspJpnExamplesCompanion toCompanion(bool nullToAbsent) {
    return EspJpnExamplesCompanion(
      ...
      dictionaryId: dictionaryId == null && nullToAbsent
          ? const Value.absent()
          : Value(dictionaryId),
  ...
  EspJpnExampleTableData copyWith(
      ...
      EspJpnExampleTableData(
        ...
        dictionaryId:
            dictionaryId.present ? dictionaryId.value : this.dictionaryId,
...
class $EspJpnSupplementsTable extends EspJpnSupplements
  ...
  late final GeneratedColumn<int> exampleId = GeneratedColumn<int>(
      ...
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES examples (example_id) ON DELETE CASCADE'));
  @override
  List<GeneratedColumn> get $columns =>
...
class $JpnEspExamplesTable extends JpnEspExamples
  ...
  late final GeneratedColumn<int> wordId = GeneratedColumn<int>(
      ...
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES jpn_esp_dictionaries (jpn_esp_dictionary_id) ON DELETE CASCADE'));
  static const VerificationMeta _exampleNoMeta =
      const VerificationMeta('exampleNo');
  @override
  late final GeneratedColumn<int> exampleNo = GeneratedColumn<int>(
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules(
        [
          WritePropagation(
            ...
            result: [
              TableUpdate('conjugations', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('words',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('dictionaries', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('dictionaries',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('examples', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('dictionaries',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('idioms', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('words',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('part_of_speech_lists', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('words',
          ...
          WritePropagation(
            on: TableUpdateQuery.onTableName('dictionaries',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('supplements', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('examples',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('supplements', kind: UpdateKind.delete),
            ],
          ...
          WritePropagation(
            on: TableUpdateQuery.onTableName('words',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('word_status', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('jpn_esp_words',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('jpn_esp_word_status', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('jpn_esp_words',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('jpn_esp_dictionaries', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('jpn_esp_dictionaries',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('jpn_esp_examples', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('words',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('es_en_conjugacions', kind: UpdateKind.delete),
            ],
          ),
        ],
      );
...
final class $$EspJpnWordsTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspJpnWordsTable, EspJpnWordTableData> {
  $$EspJpnWordsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$EspConjugationsTable,
      List<EspConjugationTableData>> _espConjugationsRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.espConjugations,
          aliasName: $_aliasNameGenerator(
              db.espJpnWords.wordId, db.espConjugations.wordId));

  $$EspConjugationsTableProcessedTableManager get espConjugationsRefs {
    final manager =
        $$EspConjugationsTableTableManager($_db, $_db.espConjugations).filter(
            (f) => f.wordId.wordId.sqlEquals($_itemColumn<int>('word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_espConjugationsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$EspJpnDictionariesTable,
      List<EspJpnDictionaryTableData>> _espJpnDictionariesRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.espJpnDictionaries,
          aliasName: $_aliasNameGenerator(
              db.espJpnWords.wordId, db.espJpnDictionaries.wordId));

  $$EspJpnDictionariesTableProcessedTableManager get espJpnDictionariesRefs {
    final manager = $$EspJpnDictionariesTableTableManager(
            $_db, $_db.espJpnDictionaries)
        .filter(
            (f) => f.wordId.wordId.sqlEquals($_itemColumn<int>('word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_espJpnDictionariesRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$PartOfSpeechListsTable, List<PartOfSpeechList>>
      _partOfSpeechListsRefsTable(_$DatabaseProvider db) =>
          MultiTypedResultKey.fromTable(db.partOfSpeechLists,
              aliasName: $_aliasNameGenerator(
                  db.espJpnWords.wordId, db.partOfSpeechLists.wordId));

  $$PartOfSpeechListsTableProcessedTableManager get partOfSpeechListsRefs {
    final manager = $$PartOfSpeechListsTableTableManager(
            $_db, $_db.partOfSpeechLists)
        .filter(
            (f) => f.wordId.wordId.sqlEquals($_itemColumn<int>('word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_partOfSpeechListsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$RankingsTable, List<RankingTableData>>
      _rankingsRefsTable(_$DatabaseProvider db) =>
          MultiTypedResultKey.fromTable(db.rankings,
              aliasName: $_aliasNameGenerator(
                  db.espJpnWords.wordId, db.rankings.wordId));

  $$RankingsTableProcessedTableManager get rankingsRefs {
    final manager = $$RankingsTableTableManager($_db, $_db.rankings).filter(
        (f) => f.wordId.wordId.sqlEquals($_itemColumn<int>('word_id')!));
  ...
  static MultiTypedResultKey<$EspJpnWordStatusTable,
      List<EspJpnWordStatusTableData>> _espJpnWordStatusRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.espJpnWordStatus,
          aliasName: $_aliasNameGenerator(
              db.espJpnWords.wordId, db.espJpnWordStatus.wordId));

  $$EspJpnWordStatusTableProcessedTableManager get espJpnWordStatusRefs {
    final manager =
        $$EspJpnWordStatusTableTableManager($_db, $_db.espJpnWordStatus).filter(
            (f) => f.wordId.wordId.sqlEquals($_itemColumn<int>('word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_espJpnWordStatusRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$EsEnConjugacionsTable,
      List<EsEnConjugacionTableData>> _esEnConjugacionsRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.esEnConjugacions,
          aliasName: $_aliasNameGenerator(
              db.espJpnWords.wordId, db.esEnConjugacions.wordId));

  $$EsEnConjugacionsTableProcessedTableManager get esEnConjugacionsRefs {
    final manager =
        $$EsEnConjugacionsTableTableManager($_db, $_db.esEnConjugacions).filter(
            (f) => f.wordId.wordId.sqlEquals($_itemColumn<int>('word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_esEnConjugacionsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
...
class $$EspJpnWordsTableFilterComposer
  ...
  Expression<bool> espConjugationsRefs(
      Expression<bool> Function($$EspConjugationsTableFilterComposer f) f) {
    final $$EspConjugationsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.espConjugations,
  ...
  Expression<bool> espJpnDictionariesRefs(
      Expression<bool> Function($$EspJpnDictionariesTableFilterComposer f) f) {
    final $$EspJpnDictionariesTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.espJpnDictionaries,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
  ...
  Expression<bool> partOfSpeechListsRefs(
      Expression<bool> Function($$PartOfSpeechListsTableFilterComposer f) f) {
    final $$PartOfSpeechListsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.partOfSpeechLists,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
  ...
  Expression<bool> espJpnWordStatusRefs(
      Expression<bool> Function($$EspJpnWordStatusTableFilterComposer f) f) {
    final $$EspJpnWordStatusTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.espJpnWordStatus,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
  ...
  Expression<bool> esEnConjugacionsRefs(
      Expression<bool> Function($$EsEnConjugacionsTableFilterComposer f) f) {
    final $$EsEnConjugacionsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.esEnConjugacions,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$EspJpnWordsTableAnnotationComposer
  ...
  Expression<T> espConjugationsRefs<T extends Object>(
      Expression<T> Function($$EspConjugationsTableAnnotationComposer a) f) {
    final $$EspConjugationsTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.espConjugations,
        getReferencedColumn: (t) => t.wordId,
  ...
  Expression<T> espJpnDictionariesRefs<T extends Object>(
      Expression<T> Function($$EspJpnDictionariesTableAnnotationComposer a) f) {
    final $$EspJpnDictionariesTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.wordId,
            referencedTable: $db.espJpnDictionaries,
  ...
  Expression<T> partOfSpeechListsRefs<T extends Object>(
      Expression<T> Function($$PartOfSpeechListsTableAnnotationComposer a) f) {
    final $$PartOfSpeechListsTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.wordId,
            referencedTable: $db.partOfSpeechLists,
  ...
  Expression<T> espJpnWordStatusRefs<T extends Object>(
      Expression<T> Function($$EspJpnWordStatusTableAnnotationComposer a) f) {
    final $$EspJpnWordStatusTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.espJpnWordStatus,
        getReferencedColumn: (t) => t.wordId,
  ...
  Expression<T> esEnConjugacionsRefs<T extends Object>(
      Expression<T> Function($$EsEnConjugacionsTableAnnotationComposer a) f) {
    final $$EsEnConjugacionsTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.esEnConjugacions,
        getReferencedColumn: (t) => t.wordId,
...
class $$EspJpnWordsTableTableManager extends RootTableManager<
    ...
    (EspJpnWordTableData, $$EspJpnWordsTableReferences),
    EspJpnWordTableData,
    PrefetchHooks Function(
        {bool espConjugationsRefs,
        bool espJpnDictionariesRefs,
        bool partOfSpeechListsRefs,
        bool rankingsRefs,
        bool espJpnWordStatusRefs,
  ...
  $$EspJpnWordsTableTableManager(_$DatabaseProvider db, $EspJpnWordsTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspJpnWordsTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {espConjugationsRefs = false,
              espJpnDictionariesRefs = false,
              partOfSpeechListsRefs = false,
              rankingsRefs = false,
              espJpnWordStatusRefs = false,
              esEnConjugacionsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (espConjugationsRefs) db.espConjugations,
                if (espJpnDictionariesRefs) db.espJpnDictionaries,
                if (partOfSpeechListsRefs) db.partOfSpeechLists,
                if (rankingsRefs) db.rankings,
                if (espJpnWordStatusRefs) db.espJpnWordStatus,
                if (esEnConjugacionsRefs) db.esEnConjugacions
              ],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (espConjugationsRefs)
                    await $_getPrefetchedData<EspJpnWordTableData,
                            $EspJpnWordsTable, EspConjugationTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnWordsTableReferences
                            ._espConjugationsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnWordsTableReferences(db, table, p0)
                                .espConjugationsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items),
                  if (espJpnDictionariesRefs)
                    await $_getPrefetchedData<EspJpnWordTableData,
                            $EspJpnWordsTable, EspJpnDictionaryTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnWordsTableReferences
                            ._espJpnDictionariesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnWordsTableReferences(db, table, p0)
                                .espJpnDictionariesRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items),
                  if (partOfSpeechListsRefs)
                    await $_getPrefetchedData<EspJpnWordTableData,
                            $EspJpnWordsTable, PartOfSpeechList>(
                        currentTable: table,
                        referencedTable: $$EspJpnWordsTableReferences
                            ._partOfSpeechListsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnWordsTableReferences(db, table, p0)
                                .partOfSpeechListsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items),
                  if (rankingsRefs)
                    await $_getPrefetchedData<EspJpnWordTableData,
                            $EspJpnWordsTable, RankingTableData>(
                        currentTable: table,
                        referencedTable:
                            $$EspJpnWordsTableReferences._rankingsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnWordsTableReferences(db, table, p0)
                                .rankingsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items),
                  if (espJpnWordStatusRefs)
                    await $_getPrefetchedData<EspJpnWordTableData,
                            $EspJpnWordsTable, EspJpnWordStatusTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnWordsTableReferences
                            ._espJpnWordStatusRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnWordsTableReferences(db, table, p0)
                                .espJpnWordStatusRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items),
                  if (esEnConjugacionsRefs)
                    await $_getPrefetchedData<EspJpnWordTableData,
                            $EspJpnWordsTable, EsEnConjugacionTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnWordsTableReferences
                            ._esEnConjugacionsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnWordsTableReferences(db, table, p0)
                                .esEnConjugacionsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items)
...
final class $$EspConjugationsTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspConjugationsTable, EspConjugationTableData> {
  $$EspConjugationsTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.espJpnWords.createAlias($_aliasNameGenerator(
          db.espConjugations.wordId, db.espJpnWords.wordId));

  $$EspJpnWordsTableProcessedTableManager get wordId {
    final $_column = $_itemColumn<int>('word_id')!;

    final manager = $$EspJpnWordsTableTableManager($_db, $_db.espJpnWords)
...
class $$EspConjugationsTableFilterComposer
  ...
  $$EspJpnWordsTableFilterComposer get wordId {
    final $$EspJpnWordsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.espJpnWords,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$EspConjugationsTableTableManager extends RootTableManager<
    ...
    (EspConjugationTableData, $$EspConjugationsTableReferences),
    EspConjugationTableData,
  ...
  $$EspConjugationsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspConjugationsTableReferences(db, table, e)
                  ))
              .toList(),
              ...
              addJoins: <
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$EspConjugationsTableReferences._wordIdTable(db),
                    referencedColumn: $$EspConjugationsTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
...
final class $$EspJpnDictionariesTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspJpnDictionariesTable, EspJpnDictionaryTableData> {
  $$EspJpnDictionariesTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.espJpnWords.createAlias($_aliasNameGenerator(
          db.espJpnDictionaries.wordId, db.espJpnWords.wordId));
  ...
  static MultiTypedResultKey<$EspJpnExamplesTable, List<EspJpnExampleTableData>>
      _espJpnExamplesRefsTable(_$DatabaseProvider db) =>
          MultiTypedResultKey.fromTable(db.espJpnExamples,
              aliasName: $_aliasNameGenerator(
                  db.espJpnDictionaries.dictionaryId,
                  db.espJpnExamples.dictionaryId));

  $$EspJpnExamplesTableProcessedTableManager get espJpnExamplesRefs {
    final manager = $$EspJpnExamplesTableTableManager($_db, $_db.espJpnExamples)
        .filter((f) => f.dictionaryId.dictionaryId
            .sqlEquals($_itemColumn<int>('dictionary_id')!));

    final cache = $_typedResult.readTableOrNull(_espJpnExamplesRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$EspJpnIdiomsTable, List<EspJpnIdiomTableData>>
      _espJpnIdiomsRefsTable(_$DatabaseProvider db) =>
          MultiTypedResultKey.fromTable(db.espJpnIdioms,
              aliasName: $_aliasNameGenerator(
                  db.espJpnDictionaries.dictionaryId,
                  db.espJpnIdioms.dictionaryId));

  $$EspJpnIdiomsTableProcessedTableManager get espJpnIdiomsRefs {
    final manager = $$EspJpnIdiomsTableTableManager($_db, $_db.espJpnIdioms)
        .filter((f) => f.dictionaryId.dictionaryId
            .sqlEquals($_itemColumn<int>('dictionary_id')!));

    final cache = $_typedResult.readTableOrNull(_espJpnIdiomsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$EspJpnSupplementsTable,
      List<EspJpnSupplementTableData>> _espJpnSupplementsRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.espJpnSupplements,
          aliasName: $_aliasNameGenerator(db.espJpnDictionaries.dictionaryId,
              db.espJpnSupplements.dictionaryId));

  $$EspJpnSupplementsTableProcessedTableManager get espJpnSupplementsRefs {
    final manager =
    ...
    final cache =
        $_typedResult.readTableOrNull(_espJpnSupplementsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
...
class $$EspJpnDictionariesTableFilterComposer
  ...
  Expression<bool> espJpnExamplesRefs(
      Expression<bool> Function($$EspJpnExamplesTableFilterComposer f) f) {
    final $$EspJpnExamplesTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnExamples,
  ...
  Expression<bool> espJpnIdiomsRefs(
      Expression<bool> Function($$EspJpnIdiomsTableFilterComposer f) f) {
    final $$EspJpnIdiomsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnIdioms,
        getReferencedColumn: (t) => t.dictionaryId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
  ...
  Expression<bool> espJpnSupplementsRefs(
      Expression<bool> Function($$EspJpnSupplementsTableFilterComposer f) f) {
    final $$EspJpnSupplementsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnSupplements,
        getReferencedColumn: (t) => t.dictionaryId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$EspJpnDictionariesTableAnnotationComposer
  ...
  Expression<T> espJpnExamplesRefs<T extends Object>(
      Expression<T> Function($$EspJpnExamplesTableAnnotationComposer a) f) {
    final $$EspJpnExamplesTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnExamples,
        getReferencedColumn: (t) => t.dictionaryId,
  ...
  Expression<T> espJpnIdiomsRefs<T extends Object>(
      Expression<T> Function($$EspJpnIdiomsTableAnnotationComposer a) f) {
    final $$EspJpnIdiomsTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnIdioms,
        getReferencedColumn: (t) => t.dictionaryId,
  ...
  Expression<T> espJpnSupplementsRefs<T extends Object>(
      Expression<T> Function($$EspJpnSupplementsTableAnnotationComposer a) f) {
    final $$EspJpnSupplementsTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.dictionaryId,
            referencedTable: $db.espJpnSupplements,
...
class $$EspJpnDictionariesTableTableManager extends RootTableManager<
    ...
    (EspJpnDictionaryTableData, $$EspJpnDictionariesTableReferences),
    EspJpnDictionaryTableData,
    PrefetchHooks Function(
        {bool wordId,
        bool espJpnExamplesRefs,
        bool espJpnIdiomsRefs,
        bool espJpnSupplementsRefs})> {
  $$EspJpnDictionariesTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspJpnDictionariesTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {wordId = false,
              espJpnExamplesRefs = false,
              espJpnIdiomsRefs = false,
              espJpnSupplementsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (espJpnExamplesRefs) db.espJpnExamples,
                if (espJpnIdiomsRefs) db.espJpnIdioms,
                if (espJpnSupplementsRefs) db.espJpnSupplements
              ],
              addJoins: <
                  T extends TableManagerState<
                      dynamic,
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.wordId,
                    referencedTable:
                        $$EspJpnDictionariesTableReferences._wordIdTable(db),
                    referencedColumn: $$EspJpnDictionariesTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (espJpnExamplesRefs)
                    await $_getPrefetchedData<EspJpnDictionaryTableData,
                            $EspJpnDictionariesTable, EspJpnExampleTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnDictionariesTableReferences
                            ._espJpnExamplesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnDictionariesTableReferences(db, table, p0)
                                .espJpnExamplesRefs,
                        referencedItemsForCurrentItem:
                  ...
                  if (espJpnIdiomsRefs)
                    await $_getPrefetchedData<EspJpnDictionaryTableData,
                            $EspJpnDictionariesTable, EspJpnIdiomTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnDictionariesTableReferences
                            ._espJpnIdiomsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnDictionariesTableReferences(db, table, p0)
                                .espJpnIdiomsRefs,
                        referencedItemsForCurrentItem:
                  ...
                  if (espJpnSupplementsRefs)
                    await $_getPrefetchedData<
                        ...
                        currentTable: table,
                        referencedTable: $$EspJpnDictionariesTableReferences
                            ._espJpnSupplementsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnDictionariesTableReferences(db, table, p0)
                                .espJpnSupplementsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems.where(
                                (e) => e.dictionaryId == item.dictionaryId),
                        typedResults: items)
...
final class $$EspJpnExamplesTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspJpnExamplesTable, EspJpnExampleTableData> {
  $$EspJpnExamplesTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnDictionariesTable _dictionaryIdTable(_$DatabaseProvider db) =>
      db.espJpnDictionaries.createAlias($_aliasNameGenerator(
          db.espJpnExamples.dictionaryId, db.espJpnDictionaries.dictionaryId));

  $$EspJpnDictionariesTableProcessedTableManager? get dictionaryId {
  ...
  static MultiTypedResultKey<$EspJpnSupplementsTable,
      ...
      MultiTypedResultKey.fromTable(db.espJpnSupplements,
          aliasName: $_aliasNameGenerator(
              db.espJpnExamples.exampleId, db.espJpnSupplements.exampleId));

  $$EspJpnSupplementsTableProcessedTableManager get espJpnSupplementsRefs {
    final manager = $$EspJpnSupplementsTableTableManager(
            $_db, $_db.espJpnSupplements)
        .filter((f) =>
            f.exampleId.exampleId.sqlEquals($_itemColumn<int>('example_id')!));
...
class $$EspJpnExamplesTableFilterComposer
  ...
  $$EspJpnDictionariesTableFilterComposer get dictionaryId {
    final $$EspJpnDictionariesTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnDictionaries,
...
class $$EspJpnExamplesTableOrderingComposer
  ...
  $$EspJpnDictionariesTableOrderingComposer get dictionaryId {
    final $$EspJpnDictionariesTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.espJpnDictionaries,
        getReferencedColumn: (t) => t.dictionaryId,
...
class $$EspJpnExamplesTableAnnotationComposer
  ...
  $$EspJpnDictionariesTableAnnotationComposer get dictionaryId {
    final $$EspJpnDictionariesTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.dictionaryId,
...
class $$EspJpnExamplesTableTableManager extends RootTableManager<
    ...
    (EspJpnExampleTableData, $$EspJpnExamplesTableReferences),
    EspJpnExampleTableData,
    PrefetchHooks Function({bool dictionaryId, bool espJpnSupplementsRefs})> {
  $$EspJpnExamplesTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspJpnExamplesTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {dictionaryId = false, espJpnSupplementsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (espJpnSupplementsRefs) db.espJpnSupplements
              ...
              addJoins: <
                ...
                if (dictionaryId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$EspJpnExamplesTableReferences._dictionaryIdTable(db),
                    referencedColumn: $$EspJpnExamplesTableReferences
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (espJpnSupplementsRefs)
                    await $_getPrefetchedData<EspJpnExampleTableData,
                            $EspJpnExamplesTable, EspJpnSupplementTableData>(
                        currentTable: table,
                        referencedTable: $$EspJpnExamplesTableReferences
                            ._espJpnSupplementsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$EspJpnExamplesTableReferences(db, table, p0)
                                .espJpnSupplementsRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.exampleId == item.exampleId),
                        typedResults: items)
                ];
              },
            );
...
final class $$EspJpnIdiomsTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspJpnIdiomsTable, EspJpnIdiomTableData> {
  $$EspJpnIdiomsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnDictionariesTable _dictionaryIdTable(_$DatabaseProvider db) =>
      db.espJpnDictionaries.createAlias($_aliasNameGenerator(
          db.espJpnIdioms.dictionaryId, db.espJpnDictionaries.dictionaryId));
...
class $$EspJpnIdiomsTableTableManager extends RootTableManager<
    ...
    (EspJpnIdiomTableData, $$EspJpnIdiomsTableReferences),
    EspJpnIdiomTableData,
  ...
  $$EspJpnIdiomsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspJpnIdiomsTableReferences(db, table, e)
                  ))
              .toList(),
              ...
              addJoins: <
                ...
                if (dictionaryId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.dictionaryId,
                    referencedTable:
                        $$EspJpnIdiomsTableReferences._dictionaryIdTable(db),
                    referencedColumn: $$EspJpnIdiomsTableReferences
                        ._dictionaryIdTable(db)
                        .dictionaryId,
                  ) as T;
                }
...
final class $$PartOfSpeechListsTableReferences extends BaseReferences<
    _$DatabaseProvider, $PartOfSpeechListsTable, PartOfSpeechList> {
  $$PartOfSpeechListsTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.espJpnWords.createAlias($_aliasNameGenerator(
          db.partOfSpeechLists.wordId, db.espJpnWords.wordId));
...
class $$PartOfSpeechListsTableTableManager extends RootTableManager<
    ...
    (PartOfSpeechList, $$PartOfSpeechListsTableReferences),
    PartOfSpeechList,
    PrefetchHooks Function({bool wordId})> {
  $$PartOfSpeechListsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$PartOfSpeechListsTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({wordId = false}) {
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.wordId,
                    referencedTable:
                        $$PartOfSpeechListsTableReferences._wordIdTable(db),
                    referencedColumn: $$PartOfSpeechListsTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
...
final class $$RankingsTableReferences extends BaseReferences<_$DatabaseProvider,
    $RankingsTable, RankingTableData> {
  $$RankingsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.espJpnWords.createAlias(
          $_aliasNameGenerator(db.rankings.wordId, db.espJpnWords.wordId));
...
class $$RankingsTableTableManager extends RootTableManager<
    ...
    (RankingTableData, $$RankingsTableReferences),
    RankingTableData,
    PrefetchHooks Function({bool wordId})> {
              ...
              addJoins: <
                ...
                if (wordId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.wordId,
                    referencedTable: $$RankingsTableReferences._wordIdTable(db),
                    referencedColumn:
                        $$RankingsTableReferences._wordIdTable(db).wordId,
                  ) as T;
                }
...
final class $$EspJpnSupplementsTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspJpnSupplementsTable, EspJpnSupplementTableData> {
  $$EspJpnSupplementsTableReferences(
      super.$_db, super.$_table, super.$_typedResult);
  ...
  static $EspJpnExamplesTable _exampleIdTable(_$DatabaseProvider db) =>
      db.espJpnExamples.createAlias($_aliasNameGenerator(
          db.espJpnSupplements.exampleId, db.espJpnExamples.exampleId));

  $$EspJpnExamplesTableProcessedTableManager? get exampleId {
    final $_column = $_itemColumn<int>('example_id');
    if ($_column == null) return null;
    final manager = $$EspJpnExamplesTableTableManager($_db, $_db.espJpnExamples)
        .filter((f) => f.exampleId.sqlEquals($_column));
...
class $$EspJpnSupplementsTableFilterComposer
  ...
  $$EspJpnExamplesTableFilterComposer get exampleId {
    final $$EspJpnExamplesTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.exampleId,
        referencedTable: $db.espJpnExamples,
...
class $$EspJpnSupplementsTableOrderingComposer
  ...
  $$EspJpnExamplesTableOrderingComposer get exampleId {
    final $$EspJpnExamplesTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.exampleId,
        referencedTable: $db.espJpnExamples,
        getReferencedColumn: (t) => t.exampleId,
...
class $$EspJpnSupplementsTableAnnotationComposer
  ...
  $$EspJpnExamplesTableAnnotationComposer get exampleId {
    final $$EspJpnExamplesTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.exampleId,
        referencedTable: $db.espJpnExamples,
...
class $$EspJpnSupplementsTableTableManager extends RootTableManager<
    ...
    (EspJpnSupplementTableData, $$EspJpnSupplementsTableReferences),
    EspJpnSupplementTableData,
  ...
  $$EspJpnSupplementsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspJpnSupplementsTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({dictionaryId = false, exampleId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
                ...
                if (dictionaryId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.dictionaryId,
                    referencedTable: $$EspJpnSupplementsTableReferences
                        ._dictionaryIdTable(db),
                    referencedColumn: $$EspJpnSupplementsTableReferences
                        ._dictionaryIdTable(db)
                        .dictionaryId,
                  ) as T;
                }
                if (exampleId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$EspJpnSupplementsTableReferences._exampleIdTable(db),
                    referencedColumn: $$EspJpnSupplementsTableReferences
                        ._exampleIdTable(db)
                        .exampleId,
                  ) as T;
...
final class $$EspJpnWordStatusTableReferences extends BaseReferences<
    _$DatabaseProvider, $EspJpnWordStatusTable, EspJpnWordStatusTableData> {
  $$EspJpnWordStatusTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.espJpnWords.createAlias($_aliasNameGenerator(
          db.espJpnWordStatus.wordId, db.espJpnWords.wordId));
...
class $$EspJpnWordStatusTableTableManager extends RootTableManager<
    ...
    (EspJpnWordStatusTableData, $$EspJpnWordStatusTableReferences),
    EspJpnWordStatusTableData,
    PrefetchHooks Function({bool wordId})> {
  $$EspJpnWordStatusTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EspJpnWordStatusTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({wordId = false}) {
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.wordId,
                    referencedTable:
                        $$EspJpnWordStatusTableReferences._wordIdTable(db),
                    referencedColumn: $$EspJpnWordStatusTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
...
final class $$JpnEspWordsTableReferences extends BaseReferences<
    _$DatabaseProvider, $JpnEspWordsTable, JpnEspWordTableData> {
  $$JpnEspWordsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$JpnEspWordStatusTable,
      List<JpnEspWordStatusTableData>> _jpnEspWordStatusRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.jpnEspWordStatus,
          aliasName: $_aliasNameGenerator(
              db.jpnEspWords.wordId, db.jpnEspWordStatus.wordId));

  $$JpnEspWordStatusTableProcessedTableManager get jpnEspWordStatusRefs {
    final manager = $$JpnEspWordStatusTableTableManager(
            $_db, $_db.jpnEspWordStatus)
        .filter((f) =>
            f.wordId.wordId.sqlEquals($_itemColumn<int>('jpn_esp_word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_jpnEspWordStatusRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }

  static MultiTypedResultKey<$JpnEspDictionariesTable,
      List<JpnEspDictionaryTableData>> _jpnEspDictionariesRefsTable(
          _$DatabaseProvider db) =>
      MultiTypedResultKey.fromTable(db.jpnEspDictionaries,
          aliasName: $_aliasNameGenerator(
              db.jpnEspWords.wordId, db.jpnEspDictionaries.wordId));

  $$JpnEspDictionariesTableProcessedTableManager get jpnEspDictionariesRefs {
    final manager = $$JpnEspDictionariesTableTableManager(
            $_db, $_db.jpnEspDictionaries)
        .filter((f) =>
            f.wordId.wordId.sqlEquals($_itemColumn<int>('jpn_esp_word_id')!));

    final cache =
        $_typedResult.readTableOrNull(_jpnEspDictionariesRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
...
class $$JpnEspWordsTableFilterComposer
  ...
  Expression<bool> jpnEspWordStatusRefs(
      Expression<bool> Function($$JpnEspWordStatusTableFilterComposer f) f) {
    final $$JpnEspWordStatusTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.jpnEspWordStatus,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
  ...
  Expression<bool> jpnEspDictionariesRefs(
      Expression<bool> Function($$JpnEspDictionariesTableFilterComposer f) f) {
...
class $$JpnEspWordsTableAnnotationComposer
  ...
  Expression<T> jpnEspWordStatusRefs<T extends Object>(
      Expression<T> Function($$JpnEspWordStatusTableAnnotationComposer a) f) {
    final $$JpnEspWordStatusTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.jpnEspWordStatus,
        getReferencedColumn: (t) => t.wordId,
  ...
  Expression<T> jpnEspDictionariesRefs<T extends Object>(
      Expression<T> Function($$JpnEspDictionariesTableAnnotationComposer a) f) {
...
class $$JpnEspWordsTableTableManager extends RootTableManager<
    ...
    (JpnEspWordTableData, $$JpnEspWordsTableReferences),
    JpnEspWordTableData,
    PrefetchHooks Function(
  ...
  $$JpnEspWordsTableTableManager(_$DatabaseProvider db, $JpnEspWordsTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$JpnEspWordsTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {jpnEspWordStatusRefs = false, jpnEspDictionariesRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (jpnEspWordStatusRefs) db.jpnEspWordStatus,
                if (jpnEspDictionariesRefs) db.jpnEspDictionaries
              ],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (jpnEspWordStatusRefs)
                    await $_getPrefetchedData<JpnEspWordTableData,
                            $JpnEspWordsTable, JpnEspWordStatusTableData>(
                        currentTable: table,
                        referencedTable: $$JpnEspWordsTableReferences
                            ._jpnEspWordStatusRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$JpnEspWordsTableReferences(db, table, p0)
                                .jpnEspWordStatusRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items),
                  if (jpnEspDictionariesRefs)
                    await $_getPrefetchedData<JpnEspWordTableData,
                            $JpnEspWordsTable, JpnEspDictionaryTableData>(
                        currentTable: table,
                        referencedTable: $$JpnEspWordsTableReferences
                            ._jpnEspDictionariesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$JpnEspWordsTableReferences(db, table, p0)
                                .jpnEspDictionariesRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.wordId == item.wordId),
                        typedResults: items)
...
final class $$JpnEspWordStatusTableReferences extends BaseReferences<
    _$DatabaseProvider, $JpnEspWordStatusTable, JpnEspWordStatusTableData> {
  $$JpnEspWordStatusTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $JpnEspWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.jpnEspWords.createAlias($_aliasNameGenerator(
          db.jpnEspWordStatus.wordId, db.jpnEspWords.wordId));

  $$JpnEspWordsTableProcessedTableManager get wordId {
    final $_column = $_itemColumn<int>('jpn_esp_word_id')!;

    final manager = $$JpnEspWordsTableTableManager($_db, $_db.jpnEspWords)
        .filter((f) => f.wordId.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_wordIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
...
class $$JpnEspWordStatusTableFilterComposer
  ...
  $$JpnEspWordsTableFilterComposer get wordId {
    final $$JpnEspWordsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.wordId,
        referencedTable: $db.jpnEspWords,
        getReferencedColumn: (t) => t.wordId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$JpnEspWordStatusTableTableManager extends RootTableManager<
    ...
    (JpnEspWordStatusTableData, $$JpnEspWordStatusTableReferences),
    JpnEspWordStatusTableData,
    PrefetchHooks Function({bool wordId})> {
  $$JpnEspWordStatusTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$JpnEspWordStatusTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({wordId = false}) {
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.wordId,
                    referencedTable:
                        $$JpnEspWordStatusTableReferences._wordIdTable(db),
                    referencedColumn: $$JpnEspWordStatusTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
...
final class $$JpnEspDictionariesTableReferences extends BaseReferences<
    _$DatabaseProvider, $JpnEspDictionariesTable, JpnEspDictionaryTableData> {
  $$JpnEspDictionariesTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $JpnEspWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.jpnEspWords.createAlias($_aliasNameGenerator(
          db.jpnEspDictionaries.wordId, db.jpnEspWords.wordId));
  ...
  static MultiTypedResultKey<$JpnEspExamplesTable, List<JpnEspExampleTableData>>
      _jpnEspExamplesRefsTable(_$DatabaseProvider db) =>
...
class $$JpnEspDictionariesTableFilterComposer
  ...
  Expression<bool> jpnEspExamplesRefs(
      Expression<bool> Function($$JpnEspExamplesTableFilterComposer f) f) {
    final $$JpnEspExamplesTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
...
class $$JpnEspDictionariesTableAnnotationComposer
  ...
  Expression<T> jpnEspExamplesRefs<T extends Object>(
      Expression<T> Function($$JpnEspExamplesTableAnnotationComposer a) f) {
    final $$JpnEspExamplesTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.dictionaryId,
        referencedTable: $db.jpnEspExamples,
        getReferencedColumn: (t) => t.wordId,
...
class $$JpnEspDictionariesTableTableManager extends RootTableManager<
    ...
    (JpnEspDictionaryTableData, $$JpnEspDictionariesTableReferences),
    JpnEspDictionaryTableData,
    PrefetchHooks Function({bool wordId, bool jpnEspExamplesRefs})> {
  $$JpnEspDictionariesTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$JpnEspDictionariesTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {wordId = false, jpnEspExamplesRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (jpnEspExamplesRefs) db.jpnEspExamples
              ],
              addJoins: <
                  T extends TableManagerState<
                      dynamic,
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.wordId,
                    referencedTable:
                        $$JpnEspDictionariesTableReferences._wordIdTable(db),
                    referencedColumn: $$JpnEspDictionariesTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (jpnEspExamplesRefs)
                    await $_getPrefetchedData<JpnEspDictionaryTableData,
                            $JpnEspDictionariesTable, JpnEspExampleTableData>(
                        currentTable: table,
                        referencedTable: $$JpnEspDictionariesTableReferences
                            ._jpnEspExamplesRefsTable(db),
                        managerFromTypedResult: (p0) =>
...
final class $$JpnEspExamplesTableReferences extends BaseReferences<
    _$DatabaseProvider, $JpnEspExamplesTable, JpnEspExampleTableData> {
...
final class $$EsEnConjugacionsTableReferences extends BaseReferences<
    _$DatabaseProvider, $EsEnConjugacionsTable, EsEnConjugacionTableData> {
  $$EsEnConjugacionsTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $EspJpnWordsTable _wordIdTable(_$DatabaseProvider db) =>
      db.espJpnWords.createAlias($_aliasNameGenerator(
          db.esEnConjugacions.wordId, db.espJpnWords.wordId));
  ...
  $$EsEnConjugacionsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$EsEnConjugacionsTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({wordId = false}) {
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (wordId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.wordId,
                    referencedTable:
                        $$EsEnConjugacionsTableReferences._wordIdTable(db),
                    referencedColumn: $$EsEnConjugacionsTableReferences
                        ._wordIdTable(db)
                        .wordId,
                  ) as T;
                }
