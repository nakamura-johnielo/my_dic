...
class FetchEspJpnDictionaryInteractor implements IFetchEspJpnDictionaryUseCase {
  ...
  @override
  Future<Result<List<EspJpnDictionary>>> execute(FetchDictionaryInputData input) async {
    return await _esjDictionaryRepository.getDictionaryByWordId(input.wordId);
  }
}
