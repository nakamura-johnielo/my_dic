...
void openWordDetail(BuildContext context, {
  required String routeName,
  required CatalogWordRef word,
}) {
  final route = WordDetailRoute(word: word);
  context.pushNamed(routeName,
      pathParameters: route.pathParameters, queryParameters: route.queryParameters);
}

void openQuizGame(BuildContext context, {
  required String routeName,
  required CatalogWordRef word,
  String? displayHint,
}) {
