...
class SearchInfinityListView2 extends ConsumerStatefulWidget {
  const SearchInfinityListView2(
      {super.key,
  ...
  @override
  ConsumerState<SearchInfinityListView2> createState() =>
      _InfinityScrollState();
}

class _InfinityScrollState extends ConsumerState<SearchInfinityListView2> {
  //state varables
  ...
  @override
  void didUpdateWidget(covariant SearchInfinityListView2 oldWidget) {
