...
UserProfilePresentationSession userProfilePresentationSession(WidgetRef ref) {
...
class UserProfileLifecyclePresentationPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) =>
      UserProfilePresentationPage(
        session: userProfilePresentationSession(ref),
        updateUserProfile:
            ref.watch(userProfilePortsProvider).updateUserProfile,
        onSignOut: onSignOut,
      );
}
